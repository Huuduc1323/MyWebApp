...
new Major{MajorName="Mathematics"},
                ...
                context.SaveChanges();
                var learners = new
                Learner[] {new Learner { FirstMidName = "Carson", LastName = "Alexander",
                ...
                context.SaveChanges();
                var courses = new Course[]{new Course{CourseID=1050,Title="Chemistry",Credits=3},
                ...
                context.SaveChanges();
                var enrollments = new Enrollment[]{new Enrollment{LearnerID=1,CourseID=1050,Grade=5.5f},
